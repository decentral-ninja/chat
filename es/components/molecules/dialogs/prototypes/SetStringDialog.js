    ...
    return Promise.all([
      ...
      div.innerHTML = /* html */`
        <wct-grid auto-fill="20%">
          <section>
            ${prependGridSection}
            <wct-input id="input" maxlength="300" inputId="input" placeholder="${placeholder}" namespace="wct-input-" namespace-fallback grid-column="1/5" value="${value}" submit-search autofocus force></wct-input>
