            ...
            <dialog>
              ...
              <wct-grid auto-fill="20%">
                ...
                <section>
                  ...
                  <wct-input maxlength="10000" grid-row="2/2" grid-column="2/5" inputId="room-name" placeholder="${(roomName = await room).replace(this.roomNamePrefix, '')}" namespace="wct-middle-input-" namespace-fallback submit-search="submit-room-name" any-key-listener autofocus force></wct-input>
            ...
            <dialog>
              ...
              <wct-grid auto-fill="20%">
                <section>
                  ...
                  <wct-input grid-row="2/2" inputId="room-name-prefix" placeholder="${this.roomNamePrefix}" namespace="wct-input-" disabled></wct-input>
                  <wct-input maxlength="10000" grid-row="2/2" grid-column="2/5" inputId="room-name" placeholder="${this.randomRoom}" namespace="wct-middle-input-" namespace-fallback submit-search="submit-room-name" any-key-listener autofocus force></wct-input>
                  <wct-button grid-row="2/2" namespace="button-primary-" request-event-name="submit-room-name" click-no-toggle-active>enter</wct-button>
                </section>
              </wct-grid>
              <hr>
